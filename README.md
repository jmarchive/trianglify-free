...
I also plan to add more custom functions such as using negative parameters, customized seeds, adjustable size and **an API for any website to quote the patterns**.
